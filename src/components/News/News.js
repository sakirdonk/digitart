            ...
            <Container>
                <div className={styles.news}>
                    ...
                    <div className={styles.news__list}>
                        <NewsCard link="news1" source="UMS" date="04 Jun 2022" title="Webinar Pencegahan Bullying oleh Kemahasiswaan UMS"/>
                        <NewsCard link="news2" source="UB" date="20 Nov 2021" title="Webinar Pencegahan Seksual & Perundungan dilingkungan Kampus oleh UB"/>
                        <NewsCard link="news3" source="Gunadarma" date="27 Dec 2020" title="Dugaan Pelecehan Berujung Bullying di Gunadarma Depok"/>
                    </div>
                </div>
            </Container>
        </Background>
